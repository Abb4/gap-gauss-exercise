...
gap> normalize_matrix(A);
<A unevaluated 1 x 1 matrix over an internal ring>
gap> Display(last*A);
[ [  -1 ] ]
...
# Q 1x3 matrix
gap> A := HomalgMatrix([2, 3, 5], 1, 3, ZZ);
...
# Q 2x3 matrix
gap> A := HomalgMatrix([[-3, -6, 8], [-6, -13, 5]], 2, 2, ZZ);
<A 2 x 2 matrix over an internal ring>
gap> normalize_matrix(A);
<An unevaluated 2 x 2 matrix over an internal ring>
gap> Display(last*A);
...
# Q 3x4 matrix
gap> A := HomalgMatrix([[1, 2, 3, 8], [4, 5, 6, 11], [7, 8, 8, 50]], 3, 4, ZZ);
